...
// dibr_scatter_fill.hlsl (38747 bytes, 4 chunks)
...
R"DIBR(        // directional/background-history path do the actual fill.
...
R"DIBR(                        float bw2 = (abs(bprev.w) > 1e-6f) ? bprev.w : 1e-6f;
