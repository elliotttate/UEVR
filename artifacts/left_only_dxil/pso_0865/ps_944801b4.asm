...
;
; shader debug name: ca98e28fc98dfed12008101fd0032f66.pdb
; shader hash: ca98e28fc98dfed12008101fd0032f66
;
...
; <label>:50                                      ; preds = %118, %0
  ...
  %79 = extractvalue %dx.types.CBufRet.f32 %78, 3
  ...
  %87 = call float @dx.op.binary.f32(i32 35, float %76, float %83)  ; FMax(a,b)
  %88 = call float @dx.op.binary.f32(i32 35, float %81, float %84)  ; FMax(a,b)
  ...
  %103 = fsub fast float %77, %80
  %104 = call float @dx.op.binary.f32(i32 35, float %103, float %84)  ; FMax(a,b)
  %105 = call float @dx.op.binary.f32(i32 36, float %104, float %86)  ; FMin(a,b)
  %106 = call %dx.types.ResRet.f32 @dx.op.sample.f32(i32 60, %dx.types.Handle %91, %dx.types.Handle %92, float %89, float %105, float undef, float undef, i32 0, i32 0, i32 undef, float undef)  ; Sample(srv,sampler,coord0,coord1,coord2,coord3,offset0,offset1,offset2,clamp)
